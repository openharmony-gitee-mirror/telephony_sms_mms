...
namespace OHOS {
class SendShortMessageCallbackStub : public IRemoteStub<SMS::ISendShortMessageCallback> {
public:
    SendShortMessageCallbackStub() = default;
    virtual ~SendShortMessageCallbackStub() = default;
    virtual int32_t OnSmsSendResult(const SMS::ISendShortMessageCallback::SmsSendResult result) override;
    int OnRemoteRequest(
